...
public class ActivityConsultas extends AppCompatActivity {
    ...
    String dato;
    String campo, campo2;
    ArrayAdapter<StringBuilder> adapter, adapter2;
    ListView lv;
    String res ="null";
    Spinner sp, sp2;
    Button b1, b2;
    ...
    private final static String[] car  = {"ISC","IIA","IM","CP","LA"};
    @Override
    ...
    public void consultarAlumnos(View v){
        switch (v.getId()){
            case R.id.btn_consultar_todo:
                ...
                campo2 = sp2.getSelectedItem().toString();
                if(dato.equals("")){
    ...
    class mostrarAlumno extends AsyncTask<String, String, String>{
        ...
        protected String doInBackground(String... strings) {
            ...
            String url="http://176.48.16.21/Practicas_PHP/Api_PHP_Android/consulta_especifica_Final.php";
    ...
    class mostrarAlumnos extends AsyncTask<String, String, String>{
        ...
        protected String doInBackground(String... strings) {
            AnalizadorJSON analizadorJSON=new AnalizadorJSON();
            String url="http://176.48.16.21/Practicas_PHP/Api_PHP_Android/consultas_alumnos.php";
