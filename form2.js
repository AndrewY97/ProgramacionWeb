function binario() {
	var numero = document.forms[0].elements[9].value;
...
function cadena(){
	var cadenas =document.forms[0].elements[13].value;
	voc=0;
	conso=0;
...
function cadena2(){
	var cadena =document.forms[0].elements[13].value;
	voc=0;
...
function busca(){
	var cadena =document.forms[0].elements[13].value;
	l=document.forms[0].elements[17].value;
	//alert(l);
	let=0;
	cadena2 = cadena.split('');
	for (var i = 0; i <cadena2.length;i++) {
...
function curp(){
	var name = (document.forms[0].elements[3].value).toUpperCase();
	ape1 = (document.forms[0].elements[4].value).toUpperCase();
	ape2 = (document.forms[0].elements[5].value).toUpperCase();
	dia = document.forms[0].elements[0].value;
	mes = document.forms[0].elements[1].value;
	año = document.forms[0].elements[2].value;
	sexo = document.forms[0].elements[7].value;
	edo = document.forms[0].elements[6].value;
	c=0
	n2 = name.split('');
	ap12 = ape1.split('');
	ap22 = ape2.split(''); 
